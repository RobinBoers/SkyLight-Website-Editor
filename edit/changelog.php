...
<body>
    ...
    <div class="w3-main module-content">
        ...
        <div class="w3-container">
            ...
            <h3>What's new?</h3>
            <p>
                <b>v0.04-beta</b> This release of SkyLight introduces comments.<br />It also has a completely rewritten backend UI that is more modular and easier to maintain. It also introduces custom menus for theme development and has a new feature called Quickstart on the dashboard.<hr>
